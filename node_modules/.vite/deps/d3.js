...
function circle_default2() {
  var center2 = constant_default7([0, 0]), radius = constant_default7(90), precision = constant_default7(6), ring, rotate, stream = { point: point2 };
...
function circle_default3(radius) {
  var cr = cos2(radius), delta = 6 * radians, smallRadius = cr > 0, notHemisphere = abs3(cr) > epsilon5;
